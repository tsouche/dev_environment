# Development Workflow - v0.5 (Updated for WSL Compatibility)
...
### 5. Install VS Code Extensions (Automatic)

**Extensions are automatically installed** on first terminal connection!

When you open a terminal in VS Code (`Ctrl+``), the container will automatically install:
...
After installation completes, reload VS Code: `Ctrl+Shift+P` → "Reload Window"
